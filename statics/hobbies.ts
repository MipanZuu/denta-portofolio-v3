export const hobbies = [
  ...
  { name: "Running", icon: "🏃", note: "Clearing my head, one kilometer at a time" },
  { name: "Traveling", icon: "✈️", note: "Getting happily lost somewhere new" },
  { name: "Photography", icon: "📷", note: "Saving the moments I want to remember" },
  { name: "Cooking", icon: "🍳", note: "Following recipes very approximately" },
  { name: "Sleeping", icon: "💤", note: "My favorite recovery strategy" },
  { name: "Riding", icon: "🚲", note: "Taking the scenic route whenever possible" },
  { name: "Learning", icon: "💡", note: "Collecting questions and finding answers" },
