...
type FeedPost = {
  id: string; title: string; slug: string; excerpt: string; coverImageUrl: string | null; images: string; tags: string; publishedAt: Date | null; likeCount: number; commentCount: number;
};
