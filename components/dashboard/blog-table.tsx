...
export function BlogTable({ pages }: { pages: BlogPage[] }) {
  if (!pages.length) return <div className="dashboard-empty"><span>✦</span><h2>No posts found</h2><p>Create your first article or adjust the current filters.</p><Link className="button button-primary" href="/dashboard/blog/new">Create a post</Link></div>;
