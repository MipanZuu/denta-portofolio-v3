...
export default function Page() { return <><JsonLd data={createWebPageJsonLd("Text Pocket Tool", description, "/playground/text-pocket")} /><PlaygroundDetailHeading kind="Tool" index="03" title="Text Pocket" description="Clean up a draft without sending a single character anywhere." /><TextPocketTool /></>; }
