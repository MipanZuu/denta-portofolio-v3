...
export default function Page() { return <><JsonLd data={createWebPageJsonLd("Percentage Helper", description, "/playground/percentage-helper")} /><PlaygroundDetailHeading kind="Tool" index="03" title="Percentage Helper" description="For discounts, bills, reports, and all the times the formula disappears from your head." /><PercentageHelperTool /></>; }
